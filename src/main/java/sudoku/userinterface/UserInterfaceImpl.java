...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
	...
	private void drawGridLines(Group root) {
		...
		while(index < 8) {
			...
			Rectangle verticalLines = getLine(x_and_y + 64 * index,  BOARD_PADDING, BOARD_X_AND_Y, thickness);
			Rectangle horizontalLines = getLine(BOARD_PADDING, x_and_y + 64 * index, thickness, BOARD_X_AND_Y);
